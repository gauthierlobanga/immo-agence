                ...
                <div className="mx-auto max-w-7xl px-4">
                    <div className="mb-12 text-center">
                        ...
                        <p className="mx-auto max-w-2xl text-lg text-slate-500 dark:text-slate-400">
                            Trouvez l'agence qui vous accompagnera dans votre
                            projet immobilier parmi nos partenaires certifiés.
                        </p>
                    </div>
                            ...
                            >
                                <div className="relative h-32 bg-emerald-600">
                                    ...
                                    <div className="absolute -bottom-10 left-6">
                                        <div className="h-20 w-20 overflow-hidden rounded-2xl bg-white p-1 shadow-md">
                                            <img
                                                src={
                                                    agency.logo_url ||
                                                    `https://ui-avatars.com/api/?name=${agency.name}&background=random`
                                                }
                                ...
                                <CardContent className="p-8 pt-14">
                                    <div className="mb-2 flex items-center gap-2">
                                        <h3 className="text-xl font-bold text-slate-900 transition-colors group-hover:text-emerald-600 dark:text-white">
                                            {agency.name}
                                        </h3>
                                        {agency.is_verified && (
                                            <BadgeCheck className="h-5 w-5 fill-emerald-50 text-emerald-500" />
                                        )}
                                    </div>
                                    ...
                                    <div className="mb-4 flex items-center gap-2 text-sm text-slate-500 dark:text-slate-400">
                                        ...
                                        <span>
                                            {agency.address || 'Kinshasa, RDC'}
                                        </span>
                                    </div>

                                    <p className="mb-6 line-clamp-2 text-sm text-slate-600 dark:text-slate-400">
                                        {agency.description ||
                                            "Cette agence n'a pas encore de description détaillée."}
                                    </p>
                                    ...
                                    <div className="flex items-center justify-between border-t border-slate-100 pt-6 dark:border-slate-800">
                                        ...
                                        <Button
                                            variant="ghost"
                                            className="rounded-xl group-hover:bg-emerald-50 group-hover:text-emerald-600"
                                            asChild
                                        >
                                            <Link
                                                href={route(
