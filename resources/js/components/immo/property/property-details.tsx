...
const property = {
    ...
    agent: {
        ...
        avatar: 'https://images.unsplash.com/photo-1521119989659-a83eee488004?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NTZ8fHBlb3BsZXxlbnwwfHwwfHx8MA%3D%3D&auto=format&fit=crop&q=60&w=200',
    },
    propertyId: '66R986',
};
                ...
                <div className="space-y-6 lg:col-span-2">
                    ...
                    <div className="space-y-4">
                        <div className="flex flex-wrap items-start justify-between gap-4">
                            ...
                            <div className="text-3xl font-semibold whitespace-nowrap text-foreground lg:text-3xl">
                ...
                <div className="space-y-4">
                    ...
                    <Card className="bg-muted/50 shadow-none">
                        <CardHeader>
                            ...
                            <CardDescription>
                                See your future home up close — book a tour with
                                Real Nest today and let us help you find the
                                perfect place!
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
