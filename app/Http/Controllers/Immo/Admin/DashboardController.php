...
namespace App\Http\Controllers\Immo\Admin;
...
class DashboardController extends Controller
{
    public function adminDashboardIndex(Request $request)
    {
        if (! $this->hasDashboardSchema()) {
            return Inertia::render('immo/admin/dashboard', $this->emptyDashboardPayload($request));
        }
        ...
        return Inertia::render('immo/admin/dashboard', [
            'posts' => $posts,
            'stats' => $stats,
